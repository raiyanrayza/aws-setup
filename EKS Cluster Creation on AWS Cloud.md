...
https://docs.aws.amazon.com/eks/latest/userguide/service_IAM_role.html#create-service-role
    ...
    8. For Description, enter descriptive text such as "AmazonEKS-Cluster Role".
...
Go to compute tab and create node group
...
r. For Description, replace the current text with descriptive text such as AmazonEKS-Noderole.
...
aws eks --region us-east-1 update-kubeconfig --name newtestcluster  
